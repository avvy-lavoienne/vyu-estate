          ...
          {clients.map((client, index) => (
            <div key={index} className="bg-gray-800 rounded-lg p-8 border border-gray-700">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm">Commercial Real Estate</p>
              </div>

              <div className="mb-6">
                <h4 className="text-lg font-semibold text-white mb-2">Category</h4>
                <p className="text-gray-400 text-sm">Luxury Home Development</p>
              </div>

              <div className="mb-6">
                <h4 className="text-lg font-semibold text-white mb-2">What They Said 🤗</h4>
                <p className="text-gray-400 text-sm italic">"{client.testimonial}"</p>
              </div>

              <div className="flex items-center justify-between">
                <div>
                  <div className="text-white font-medium">{client.author}</div>
                  <div className="text-gray-400 text-sm">{client.role}</div>
                </div>
                <button className="text-purple-400 hover:text-purple-300 text-sm">Visit Website</button>
              </div>
            </div>
          ))}
        </div>
